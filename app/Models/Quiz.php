...
//    2020-08-31 chen bing add
    ...
    {
        return $this->belongsToMany(\App\Models\User::class, 'quiz_user')->withPivot('quiz_completed','completed_date', 'result', 'attempts')->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(\App\Models\House::class)->withTimestamps();
    }
