...
class Track extends Model
{
    ...
    public function users(){
        return $this->belongsToMany(\App\Models\User::class)->withTimestamps()->withPivot('track_maxile','track_test_date', 'track_passed','doneNess');
    }
    ...
    public function postReqTracks(){
        return $this->belongsToMany(\App\Models\Track::class,'track_track','preReq_track_id', 'track_id');
    }

    public function preReqTracks(){
        return $this->belongsToMany(\App\Models\Track::class, 'track_track','track_id', 'preReq_track_id');
    }

    public function courses(){
        return $this->belongsToMany(\App\Models\Course::class)->withPivot(['track_order','number_of', 'unit_id'])->withTimestamps();
    }

    public function skills(){
        return $this->belongsToMany(\App\Models\Skill::class)->withPivot(['skill_order', 'start_date', 'end_date'])->withTimestamps();
    }
    ...
    public function checkedSkills(){
        return $this->belongsToMany(\App\Models\Skill::class)->whereCheck(TRUE)->withPivot(['skill_order', 'start_date', 'end_date'])->withTimestamps();
    }
    ...
    public function houses(){
        return $this->belongsToMany(\App\Models\House::class)->withPivot(['track_order','start_date', 'end_date']);
    }

    public function unit(){
        return $this->belongsToMany(\App\Models\Unit::class,'course_track')->withPivot(['track_order','number_of', 'course_id'])->select('unit');
    }
