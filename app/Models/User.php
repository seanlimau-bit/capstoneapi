...
class User extends Authenticatable implements AuthenticatableContract, AuthorizableContract, CanResetPasswordContract
{
    ...
    */
    ...
    {
        return \App\Services\LiveService::getConfig($this);
    }
    ...
    */
    ...
    {
        return $this->hasMany(\App\Models\Mastercode::class);
    }
    
    public function lives()
    {
        return $this->hasOne(\App\Models\UserLives::class);
    }
    ...
    {
        return $this->hasMany(\App\Models\House::class, 'house_id');
    }
    ...
    */
    ...
    {
        return $this->belongsToMany(\App\Models\Field::class)
    ...
    */
    ...
    {
        return $this->belongsToMany(\App\Models\Role::class, 'house_role_user')
            ->withPivot([
                'house_id', 
                'plan_id', 
                'progress', 
    ...
    // Add this for active enrollments
    public function activeHouseRoles()
    {
        return $this->houseRoles()
            ->wherePivot('expiry_date', '>=', now())
            ->wherePivotIn('payment_status', ['paid', 'active', null]); // adjust based on your payment statuses
    }

    public function roleHouse()
    {
        return $this->belongsToMany(\App\Models\House::class, 'house_role_user')
            ->withPivot('role_id')
            ->withTimestamps();
    }
    ...
    */
    ...
    {
        return $this->belongsToMany(\App\Models\Test::class)
    ...
    {
        return $this->belongsToMany(\App\Models\Quiz::class)
    ...
    */
    ...
    {
        return $this->hasMany(\App\Models\Log::class)->orderBy('updated_at', 'desc')->take(20);
    }
