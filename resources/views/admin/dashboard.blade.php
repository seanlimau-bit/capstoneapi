    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="card bg-primary text-white">
                <div class="card-body text-center">
                    <h3>{{ number_format($stats['total_questions']) }}</h3>
        ...
        <div class="col-md-3">
            <div class="card bg-warning text-white">
                <div class="card-body text-center">
                    <h3>{{ number_format($stats['pending_qa']) }}</h3>
    ...
    <div class="row mb-4">
        <div class="col-md-4">
            <div class="card h-100">
                ...
                <div class="card-footer">
                    <a href="{{ route('qa.index') }}" class="btn btn-primary">Go to QA System</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card h-100">
                ...
                <div class="card-footer">
                    <a href="{{ route('admin.questions.index') }}" class="btn btn-success">Manage Questions</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card h-100">
                ...
                <div class="card-footer">
                    <a href="{{ route('admin.skills.index') }}" class="btn btn-info">Manage Skills</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <a href="{{ route('admin.users.partners') }}" class="btn btn-outline-success btn-block">
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            <a href="{{ route('admin.reports.usage') }}" class="btn btn-outline-info btn-block">
                                <i class="fas fa-chart-bar"></i> Usage Reports
                            </a>
                        </div>
                        <div class="col-6">
                            <a href="{{ route('admin.reports.performance') }}" class="btn btn-outline-warning btn-block">
