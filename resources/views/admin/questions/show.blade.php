...
{{-- Inline add hint box (hidden by default) --}}
  ...
  <div class="solutions-container">
    ...
    <div class="mt-2 d-flex justify-content-between align-items-center">
      ...
      <div class="d-flex align-items-center gap-2">
        {{-- Status uses the same statuses as question --}}
        <select class="form-select form-select-sm"
        data-field="status_id"
        data-id="{{ $question->id }}"
        data-current="{{ $question->status_id }}">
...
{{-- Inline add solution box (hidden by default) --}}
...
{{-- Image Preview Modal (simple lightweight) --}}
