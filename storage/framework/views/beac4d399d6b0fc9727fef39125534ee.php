...
<?php $__env->startSection('title', 'Skill: ' . $skill->skill); ?>
        ...
        <div class="col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="editable-field" data-field="skill" data-type="text">
                                <span class="field-display"><?php echo e($skill->skill); ?></span>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="editable-field" data-field="status_id" data-type="select">
                                <span class="field-display">
                                    <?php if($skill->status_id == 3): ?>
                                    <span class="badge bg-success">Active</span>
                                    <?php elseif($skill->status_id == 4): ?>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <div class="editable-field" data-field="description" data-type="textarea">
                                <span class="field-display"><?php echo e($skill->description ?: 'Click to add description...'); ?></span>
                                <i class="fas fa-edit edit-icon text-muted ms-2"></i>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Created By</label>
                            <div><?php echo e($skill->user->name ?? 'Unknown User'); ?> - <?php echo e($skill->created_at->format('M j, Y')); ?></div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Verification</label>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="skillCheck" 
                                <?php echo e($skill->check ? 'checked' : ''); ?> 
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Questions (<?php echo e($skill->questions->count()); ?>)</h5>
                    <div>
                        <button class="btn btn-sm btn-primary" onclick="SkillManager.showBulkQuestions()">
                            <i class="fas fa-plus"></i> Add Questions
                        </button>
                        <?php if($skill->questions->count() > 0): ?>
                ...
                <div class="card-body p-0">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $skill->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><span class="badge bg-light text-dark">#<?php echo e($question->id); ?></span></td>
                                    <td>
                                        <div class="fw-bold">
                                            <?php
                                            ...
                                            <?php if($shouldTruncate): ?>
                                            <?php echo e(substr($plainText, 0, 80)); ?>...
                                            <?php else: ?>
                                    ...
                                    <td>
                                        <span class="badge bg-info">
                                            <?php echo e($question->question_type ?? 'MCQ'); ?>
                                    ...
                                    ?>
                                    <span class="badge <?php echo e($badgeClass); ?>"><?php echo e(ucfirst($difficulty)); ?></span>
                                </td>
                                <td>
                                    <?php
                                ...
                                ?>
                                <span class="badge <?php echo e($statusClass); ?>"><?php echo e(ucfirst(str_replace('_', ' ', $status))); ?></span>
                            </td>
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <button class="btn btn-outline-info" onclick="SkillManager.viewQuestion(<?php echo e($question->id); ?>)" title="View">
                                        <i class="fas fa-eye"></i>
                                    </button>
                                    <button class="btn btn-outline-success" onclick="SkillManager.generateSimilar(<?php echo e($question->id); ?>, <?php echo e($skill->id); ?>, '<?php echo e(addslashes(substr($plainText, 0, 50))); ?>')" title="Generate Similar Questions">
                                        <i class="fas fa-wand-magic-sparkles"></i>
                                    </button>
                                    <button class="btn btn-outline-danger" onclick="SkillManager.deleteQuestion(<?php echo e($question->id); ?>)" title="Delete">
...
<div class="col-lg-4">
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Assigned Tracks (<?php echo e($skill->tracks->count()); ?>)</h5>
            <button class="btn btn-sm btn-outline-primary" onclick="SkillManager.showAddTrack()">
                <i class="fas fa-plus"></i> Add
            </button>
        </div>
        <div class="card-body">
            <?php if($skill->tracks->count() > 0): ?>
            <div class="list-group list-group-flush">
                <?php $__currentLoopData = $skill->tracks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $track): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                    <div>
                        <strong><?php echo e($track->track); ?></strong>
                        <?php if($track->level): ?>
                        <br><small class="text-muted">Level <?php echo e($track->level->level); ?> - <?php echo e($track->level->description); ?></small>
                        <?php endif; ?>
                    </div>
                    <button class="btn btn-sm btn-outline-danger" onclick="SkillManager.removeTrack(<?php echo e($skill->id); ?>, <?php echo e($track->id); ?>)" title="Remove track">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <?php if($skill->links && $skill->links->count() > 0): ?>
            <?php $__currentLoopData = $skill->links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="d-flex align-items-center justify-content-between mb-3">
                <div class="flex-grow-1">
                    <div class="editable-field" data-field="video_title" data-type="text" data-link-id="<?php echo e($link->id); ?>">
                        <span class="field-display">
                            <?php echo e($link->title ?? 'Video ' . $loop->iteration); ?>

                        </span>
                        <i class="fas fa-edit edit-icon text-muted ms-2"></i>
                    </div>
                    <small class="text-muted"><?php echo e(basename($link->link)); ?></small>
                </div>
                <div class="btn-group btn-group-sm">
                    <a href="<?php echo e(asset($link->link)); ?>" class="btn btn-outline-primary" target="_blank">
                        <i class="fas fa-play"></i>
                    </a>
                    <button class="btn btn-outline-danger" onclick="SkillManager.deleteVideo(<?php echo e($link->id); ?>)">
                        <i class="fas fa-trash"></i>
                    </button>
                </div>
            </div>
            ...
            <div class="modal-body">
                <form id="addTrackForm">
                    <div class="mb-3">
                        ...
                        ?>
                        <?php $__currentLoopData = $availableTracks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $track): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($track->id); ?>">
                            <?php echo e($track->track); ?>

                            <?php if($track->level): ?> (Level <?php echo e($track->level->level); ?>) <?php endif; ?>
                        </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
...
<?php echo $__env->make('admin.skills.modals.question-generation-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
 ...
 */
 class SkillManager {
    static config = {
        skillId: <?php echo e($skill->id); ?>,
        referenceData: {
            statuses: <?php echo json_encode($statuses ?? [], 15, 512) ?>,
            difficulties: <?php echo json_encode($difficulties ?? [], 15, 512) ?>,
            questionTypes: <?php echo json_encode($questionTypes ?? [], 15, 512) ?>
        },
        routes: {
            skillUpdate: '<?php echo e(route("admin.skills.update", $skill)); ?>',
            questionsGenerate: '/admin/questions/generate',
            questionDelete: '/admin/questions',
            skillCopy: '/admin/skills/<?php echo e($skill->id); ?>/duplicate',
            skillDelete: '<?php echo e(route("admin.skills.destroy", $skill)); ?>',
            exportQuestions: '/admin/skills/<?php echo e($skill->id); ?>/export-questions',
            addTrack: '/admin/skills/<?php echo e($skill->id); ?>/add-track',
            removeTrack: '/admin/skills/<?php echo e($skill->id); ?>/tracks',
            linkVideo: '/admin/skills/<?php echo e($skill->id); ?>/link-video',
            deleteVideo: '/admin/skills/<?php echo e($skill->id); ?>/videos',
...
static generateSimilar(questionId, skillId = (SkillManager.config?.skillId ?? null), questionText = null) {
  ...
  new bootstrap.Modal(modalEl).show();
    ...
    static async generateVariations(e) {
      ...
      try {
        // 2) Send to backend
        const fd = new FormData(form); // includes <?php echo csrf_field(); ?> and all inputs
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\allgifted\mathapi11v2\resources\views\admin\skills\show.blade.php ENDPATH**/ ?>