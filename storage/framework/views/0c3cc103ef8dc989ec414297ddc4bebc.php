...
<head>
    ...
    <title>Question Preview - <?php echo e($question->id); ?></title>
...
<body>
    ...
    <div class="preview-container">
        ...
        <div class="question-container">
            <div class="w-100">
                <?php if($question->question_image): ?>
                    <img src="<?php echo e(asset($question->question_image)); ?>" alt="Question" class="question-image">
                <?php endif; ?>
        ...
        <div id="answerArea">
            <?php if($question->type_id == 1): ?>
                ...
                <?php $__currentLoopData = $validOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="mcq-option" onclick="selectOption(<?php echo e($option['index']); ?>)">
                        <?php if($option['image']): ?>
                            <img src="<?php echo e(asset($option['image'])); ?>" alt="Option" style="max-width: 100%; height: auto; margin-bottom: 8px; border-radius: 8px;">
                        <?php endif; ?>
            ...
            <?php else: ?>
                ...
                <div class="bg-light p-4 rounded">
                    <div class="keypad">
                        <?php $__currentLoopData = ['1','2','3','⌫','4','5','6',':','7','8','9','.']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button class="keypad-button" onclick="handleKeypad('<?php echo e($key); ?>')">
                                <?php if($key == '⌫'): ?>
    ...
    <script>
        ...
        const correctAnswer = <?php echo e($question->correct_answer ?? 0); ?>;
        const questionType = <?php echo e($question->type_id); ?>;
...
</html><?php /**PATH C:\allgifted\mathapi11v2\resources\views\admin\questions\preview.blade.php ENDPATH**/ ?>