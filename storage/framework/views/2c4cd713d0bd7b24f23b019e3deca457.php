...
<div class="modal fade" id="questionGenerationModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form id="questionGenerationForm" method="POST" action="<?php echo e(route('admin.questions.generateQuestions')); ?>"onsubmit="return SkillManager.generateVariations(event);">
        <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\allgifted\mathapi11v2\resources\views\admin\skills\modals\question-generation-modal.blade.php ENDPATH**/ ?>