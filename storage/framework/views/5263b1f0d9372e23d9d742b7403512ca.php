                ...
                <table class="table table-hover" id="difficultiesTable">
                    <thead>
                        ...
                        <tbody>
                            ...
                            <tr data-id="<?php echo e($difficulty->id); ?>" data-status-id="<?php echo e($difficulty->status_id ?? ''); ?>"
                                class="data-row">
                                <td class="click-edit">
                                    <span class="view-mode"><?php echo e($difficulty->id); ?></span>
                                </td>
                                <td class="click-edit">
                                    <span class="view-mode"><?php echo e($difficulty->difficulty ?? ''); ?></span>
                                    <input type="number"
                                    class="form-control form-control-sm edit-mode d-none inline-edit"
                                    data-field="difficulty" value="<?php echo e($difficulty->difficulty ?? ''); ?>" min="0">
                                </td>
                                <td class="click-edit">
                                    <span class="view-mode"><?php echo e($difficulty->short_description ?? ''); ?></span>
                                    <input type="text"
                                    class="form-control form-control-sm edit-mode d-none inline-edit"
                                    data-field="short_description"
                                    value="<?php echo e($difficulty->short_description ?? ''); ?>">
                                </td>
                                <td class="click-edit">
                                    <span class="view-mode"><?php echo e($difficulty->description ?? ''); ?></span>
                                    <input type="text"
                                    class="form-control form-control-sm edit-mode d-none inline-edit"
                                    data-field="description" value="<?php echo e($difficulty->description ?? ''); ?>">
                                </td>
                                <td class="click-edit">
                                    <span class="view-mode">
                                        <span class="badge bg-secondary"><?php echo e($difficulty->status->status ?? '—'); ?></span>
                                    </span>
                                    <select class="form-control form-control-sm edit-mode d-none inline-edit" data-field="status_id">
                                        ...
                                        <option value="<?php echo e($option['id']); ?>" <?php echo e($difficulty->status_id == $option['id'] ? 'selected' : ''); ?>>
        ...
        <div class="table-responsive">
            <table class="table table-hover" id="typesTable">
                ...
                <tbody>
                    ...
                    <tr data-id="<?php echo e($type->id); ?>" data-status-id="<?php echo e($type->status_id ?? ''); ?>"
                        class="data-row">
                        <td class="click-edit"><span class="view-mode"><?php echo e($type->id); ?></span></td>
                        <td class="click-edit">
                            <span class="view-mode"><?php echo e($type->type ?? ''); ?></span>
                            <input type="text"
                            class="form-control form-control-sm edit-mode d-none inline-edit"
                            data-field="type" value="<?php echo e($type->type ?? ''); ?>">
                        </td>
                        <td class="click-edit">
                            <span class="view-mode"><?php echo e($type->description ?? ''); ?></span>
                            <input type="text"
                            class="form-control form-control-sm edit-mode d-none inline-edit"
                            data-field="description" value="<?php echo e($type->description ?? ''); ?>">
                        </td>
                        <td class="click-edit">
                            <span class="view-mode">
                                <span class="badge bg-secondary"><?php echo e($type->status->status ?? '—'); ?></span>
                            </span>
                            <select class="form-control form-control-sm edit-mode d-none inline-edit" data-field="status_id">
                                <?php $__currentLoopData = $statusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($option['id']); ?>" <?php echo e($type->status_id == $option['id'] ? 'selected' : ''); ?>>
                                    <?php echo e($option['text']); ?>
        ...
        <div class="table-responsive">
            <table class="table table-hover" id="levelsTable">
                ...
                <tbody>
                    ...
                    <tr data-id="<?php echo e($level->id); ?>" data-status-id="<?php echo e($level->status_id ?? ''); ?>"
                        class="data-row">
                        <td class="click-edit"><span class="view-mode"><?php echo e($level->id); ?></span></td>
                        <td class="click-edit">
                            <span class="view-mode"><?php echo e($level->level ?? ''); ?></span>
                            <input type="number"
                            class="form-control form-control-sm edit-mode d-none inline-edit"
                            data-field="level" value="<?php echo e($level->level ?? ''); ?>" min="0">
                        </td>
                        <td class="click-edit">
                            <span class="view-mode"><?php echo e($level->description ?? ''); ?></span>
                            <input type="text"
                            class="form-control form-control-sm edit-mode d-none inline-edit"
                            data-field="description" value="<?php echo e($level->description ?? ''); ?>">
                        </td>
                        <td class="click-edit">
                            <span class="view-mode"><?php echo e($level->age ?? ''); ?></span>
                            <input type="number"
                            class="form-control form-control-sm edit-mode d-none inline-edit"
                            data-field="age" value="<?php echo e($level->age ?? ''); ?>" min="0">
                        </td>
                        <td class="click-edit">
                            <span class="view-mode maxile-span">
                                <?php echo e($level->start_maxile_level ?? 0); ?> - <?php echo e($level->end_maxile_level ?? 0); ?>
                            ...
                            <div class="edit-mode d-none d-flex gap-1">
                                ...
                                value="<?php echo e($level->start_maxile_level ?? 0); ?>" style="width: 90px;">
                                <span>-</span>
                                <input type="number" class="form-control form-control-sm inline-edit"
                                data-field="end_maxile_level"
                                value="<?php echo e($level->end_maxile_level ?? 0); ?>" style="width: 90px;">
                            </div>
                        </td>
                        <td class="click-edit">
                            <span class="view-mode">
                                <span class="badge bg-secondary"><?php echo e($level->status->status ?? '—'); ?></span>
                            </span>
                            <select class="form-control form-control-sm edit-mode d-none inline-edit" data-field="status_id">
                                <?php $__currentLoopData = $statusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($option['id']); ?>" <?php echo e($level->status_id == $option['id'] ? 'selected' : ''); ?>>
                                    <?php echo e($option['text']); ?>
        ...
        <div class="table-responsive">
            <table class="table table-hover" id="statusesTable">
                ...
                <tbody>
                    ...
                    <tr data-id="<?php echo e($status->id); ?>" class="data-row">
                        <td class="click-edit"><span class="view-mode"><?php echo e($status->id); ?></span></td>
                        <td class="click-edit">
                            <span class="view-mode"><span
                                class="badge bg-secondary"><?php echo e($status->status ?? ''); ?></span></span>
                                <input type="text"
                                class="form-control form-control-sm edit-mode d-none inline-edit"
                                data-field="status" value="<?php echo e($status->status ?? ''); ?>">
                            </td>
                            <td class="click-edit">
                                <span class="view-mode"><?php echo e($status->description ?? ''); ?></span>
                                <input type="text"
                                class="form-control form-control-sm edit-mode d-none inline-edit"
                                data-field="description" value="<?php echo e($status->description ?? ''); ?>">
                            </td>
                            <td>
                                <button class="btn btn-sm btn-success save-row-btn edit-mode d-none"
                                title="Save"><i class="fas fa-check"></i></button>
            ...
            <div class="table-responsive">
                <table class="table table-hover" id="rolesTable">
                    ...
                    <tbody>
                        ...
                        <tr data-id="<?php echo e($role->id); ?>" data-status-id="<?php echo e($role->status_id ?? ''); ?>"
                            class="data-row">
                            <td class="click-edit"><span class="view-mode"><?php echo e($role->id); ?></span></td>
                            <td class="click-edit">
                                <span class="view-mode"><span
                                    class="badge bg-primary"><?php echo e($role->role ?? ''); ?></span></span>
                                    <input type="text"
                                    class="form-control form-control-sm edit-mode d-none inline-edit"
                                    data-field="role" value="<?php echo e($role->role ?? ''); ?>">
                                </td>
                                <td class="click-edit">
                                    <span class="view-mode"><?php echo e($role->description ?? ''); ?></span>
                                    <input type="text"
                                    class="form-control form-control-sm edit-mode d-none inline-edit"
                                    data-field="description" value="<?php echo e($role->description ?? ''); ?>">
                                </td>
                                <td><span class="badge bg-info"><?php echo e($role->users_count ?? 0); ?></span></td>
                                <td>
                                    <button class="btn btn-sm btn-success save-row-btn edit-mode d-none"
                                    title="Save"><i class="fas fa-check"></i></button>
                                    <button class="btn btn-sm btn-warning cancel-row-btn edit-mode d-none"
                ...
                <div class="table-responsive">
                    <table class="table table-hover" id="unitsTable">
                        ...
                        <tbody>
                            ...
                            <tr data-id="<?php echo e($unit->id); ?>" data-status-id="<?php echo e($unit->status_id ?? ''); ?>"
                                class="data-row">
                                <td class="click-edit"><span class="view-mode"><?php echo e($unit->id); ?></span></td>
                                <td class="click-edit">
                                    <span class="view-mode"><?php echo e($unit->unit ?? ''); ?></span>
                                    <input type="text"
                                    class="form-control form-control-sm edit-mode d-none inline-edit"
                                    data-field="unit" value="<?php echo e($unit->unit ?? ''); ?>">
                                </td>
                                <td class="click-edit">
                                    <span class="view-mode"><?php echo e($unit->description ?? ''); ?></span>
                                    <input type="text"
                                    class="form-control form-control-sm edit-mode d-none inline-edit"
                                    data-field="description" value="<?php echo e($unit->description ?? ''); ?>">
                                </td>
                                <td>
                                    <button class="btn btn-sm btn-success save-row-btn edit-mode d-none"
                                    title="Save"><i class="fas fa-check"></i></button>
...
<script>
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\allgifted\mathapi11v2\resources\views\admin\configuration\index.blade.php ENDPATH**/ ?>