...
<?php $__env->startSection('title', 'Track: ' . $track->track); ?>
        ...
        <div class="col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="editable-field" data-field="track" data-type="text">
                                <span class="field-display"><?php echo e($track->track); ?></span>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="editable-field" data-field="status_id" data-type="select">
                                <span class="field-display">
                                    <?php if($track->status_id == 3): ?>
                                        <span class="badge bg-success">Active</span>
                                    <?php elseif($track->status_id == 4): ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="editable-field" data-field="level_id" data-type="select">
                                <span class="field-display">
                                    <?php if($track->level): ?>
                                        <span class="badge bg-info">Level <?php echo e($track->level->description); ?></span>
                                    <?php else: ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="editable-field" data-field="field_id" data-type="select">
                                <span class="field-display">
                                    <?php if($track->field): ?>
                                        <span class="badge bg-secondary"><?php echo e($track->field->field); ?></span>
                                    <?php else: ?>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <div class="editable-field" data-field="description" data-type="textarea">
                                <span class="field-display"><?php echo e($track->description ?? 'No description'); ?></span>
                                <i class="fas fa-edit edit-icon text-muted ms-2"></i>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Created</label>
                            <div><?php echo e($track->created_at->format('M j, Y')); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Skills (<?php echo e($track->skills->count()); ?>)</h5>
                    <div>
                        <button class="btn btn-sm btn-success" onclick="showAddSkillForm()">
                            <i class="fas fa-plus"></i> Add Skill
                        </button>
                        <?php if($track->skills->count() > 0): ?>
                    ...
                    <?php if($track->skills->count() > 0): ?>
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $track->skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <div>
                                                <h6 class="mb-0"><?php echo e($skill->skill); ?></h6>
                                                <small class="text-muted">
                                                    <?php if(strlen($skill->description ?? '') > 100): ?>
                                                        <?php echo e(substr($skill->description, 0, 100)); ?>...
                                                    <?php else: ?>
                                                        <?php echo e($skill->description ?? 'No description'); ?>
                                        ...
                                        <td>
                                            <?php if($skill->questions && $skill->questions->count() > 0): ?>
                                                <span class="badge bg-primary"><?php echo e($skill->questions->count()); ?></span>
                                            <?php else: ?>
                                                <span class="text-muted">0</span>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <span class="badge bg-<?php echo e($skill->status && $skill->status->status === 'active' ? 'success' : 'warning'); ?>">
                                                <?php echo e($skill->status ? ucfirst($skill->status->status) : 'Unknown'); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <a href="<?php echo e(route('admin.skills.show', $skill)); ?>" class="btn btn-outline-info" title="View Skill">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <button class="btn btn-outline-danger" onclick="removeSkill(<?php echo e($skill->id); ?>)" title="Remove from Track">
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body text-center">
                    <h6 class="text-secondary mb-1"><?php echo e($track->field->field); ?></h6>
                    <p class="text-muted small mb-2"><?php echo e($track->field->description); ?></p>
                    <small class="text-muted"><?php echo e($track->field->tracks->count() ?? 0); ?> tracks in this field</small>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body text-center">
                    <?php if($track->level): ?>
                        <h4 class="text-primary mb-1">Level <?php echo e($track->level->level); ?></h4>
                        <p class="text-muted small mb-2"><?php echo e($track->level->description); ?></p>
                        <small class="text-muted"><?php echo e($track->level->tracks->count()); ?> tracks at this level</small>
                    <?php else: ?>
                        <?php echo $__env->make('admin.components.empty-state', [
                            'icon' => 'layer-group',
            ...
            <?php echo $__env->make('admin.components.management-grid', [
                'columns' => 12,
                'items' => [
                    [
            ...
            <?php echo $__env->make('admin.components.system-status', [
                'title' => 'Track Status',
                'icon' => 'heartbeat',
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Skill to "<?php echo e($track->track); ?>"</h5>
                        ...
                        <select name="skill_id" class="form-select" required id="skillSelect">
                            ...
                            <?php $__currentLoopData = $availableSkills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($skill->id); ?>">
                                    ...
                                    <?php if($skill->questions): ?> (<?php echo e($skill->questions->count()); ?> questions) <?php endif; ?>
                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <?php if($availableSkills->count() == 0): ?>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" onclick="addSkillToTrack()" 
                        <?php echo e($availableSkills->count() == 0 ? 'disabled' : ''); ?>>Add Skill</button>
            </div>
        </div>
    </div>
</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\allgifted\mathapi11v2\resources\views\admin\tracks\show.blade.php ENDPATH**/ ?>