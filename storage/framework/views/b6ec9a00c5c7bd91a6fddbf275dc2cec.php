...
<?php $__env->startSection('subtitle', 'Administration Portal'); ?>
...
<?php $__env->startPush('head'); ?> 
  ...
  <div class="auth-page">
    ...
    <div class="auth-card" role="form" aria-labelledby="authTitle">
      <h1 id="authTitle" class="auth-title"><?php echo $__env->yieldContent('title'); ?></h1>
    </div>
  </div>
  ...
  <div class="auth-body">
    ...
    <form method="POST" action="<?php echo e(route('auth.sendOtp')); ?>" id="sendForm" novalidate>
      <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
        <div class="invalid-feedback"><i class="fas fa-exclamation-triangle me-1" aria-hidden="true"></i><?php echo e($message); ?></div>
        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
    ...
    <form method="POST" action="<?php echo e(route('auth.verifyOtp')); ?>" id="verifyForm" hidden>
      <?php echo csrf_field(); ?>
      ...
      <div class="mb-3">
        ...
        <input
        type="text"
        class="form-control otp-chip <?php $__errorArgs = ['otp_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<script>
  ...
  sendForm.addEventListener('submit', async function (e) {
    ...
    const { ok, status, data } = await postJSON(<?php echo json_encode(route('auth.sendOtp'), 15, 512) ?>, { identifier, channel: ch });
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\allgifted\mathapi11v2\resources\views\auth\login.blade.php ENDPATH**/ ?>