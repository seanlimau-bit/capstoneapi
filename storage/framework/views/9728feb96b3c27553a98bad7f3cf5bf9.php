...
<?php $__env->startSection('title', 'Learning OS Dashboard'); ?>
...
<div class="learning-hero-header">
    ...
    <p class="hero-subtitle">
        Welcome back, <?php echo e(auth()->user()->firstname ?? 'Admin'); ?> | Manage your intelligent mathematics learning platform
    </p>
                ...
                <div class="hierarchy-card">
                    <div class="hierarchy-level">
                        <div class="hierarchy-content">
                            ...
                            <div class="text-end">
                                <div class="hierarchy-count"><?php echo e($counts['fields']); ?></div>
                                <div class="mt-2">
                                    <a href="<?php echo e(route('admin.fields.index')); ?>" class="btn btn-sm btn-primary">Manage</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="hierarchy-level">
                        <div class="hierarchy-content">
                            ...
                            <div class="text-end">
                                <div class="hierarchy-count"><?php echo e($counts['tracks']); ?></div>
                                <div class="mt-2">
                                    <a href="<?php echo e(route('admin.tracks.index')); ?>" class="btn btn-sm btn-primary">Manage</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="hierarchy-level">
                        <div class="hierarchy-content">
                            ...
                            <div class="text-end">
                                <div class="hierarchy-count"><?php echo e($counts['skills']); ?></div>
                                <div class="mt-2">
                                    <a href="<?php echo e(route('admin.skills.index')); ?>" class="btn btn-sm btn-primary">Manage</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="hierarchy-level">
                        <div class="hierarchy-content">
                            ...
                            <div class="text-end">
                                <div class="hierarchy-count"><?php echo e(number_format($counts['questions'])); ?></div>
                                <div class="mt-2">
                                    <a href="<?php echo e(route('admin.questions.index')); ?>" class="btn btn-sm btn-primary">Manage</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card metric-card-advanced">
                    <div class="card-body">
                        <div class="metric-header">
                            ...
                            <?php if($metrics['user_growth_rate'] > 0): ?>
                            <div class="metric-change change-positive">
                                <i class="fas fa-arrow-up"></i> <?php echo e(number_format($metrics['user_growth_rate'], 1)); ?>%
                            </div>
                            <?php endif; ?>
                        </div>
                        <div class="metric-value-large"><?php echo e(number_format($counts['active_users'])); ?></div>
                        <div class="metric-label">Active Learners</div>
                        <div class="metric-progress">
                            <div class="progress-fill" style="width: <?php echo e(min(100, ($counts['active_users'] / max($counts['total_users'], 1)) * 100)); ?>%; background: var(--grad-success);"></div>
                        </div>
                        <small class="text-muted mt-2 d-block"><?php echo e($counts['total_users']); ?> total users</small>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="metric-header">
                            ...
                            <div class="metric-change change-negative">
                                <i class="fas fa-exclamation"></i> <?php echo e($counts['pending_qa']); ?>

                            </div>
                        </div>
                        <div class="metric-value-large"><?php echo e(number_format($counts['pending_qa'])); ?></div>
                        <div class="metric-label">Needs QA Review</div>
                        <div class="metric-progress">
                            <div class="progress-fill" style="width: <?php echo e(min(100, ($counts['pending_qa'] / max($counts['questions'], 1)) * 100)); ?>%; background: var(--grad-warning);"></div>
                        </div>
                        <small class="text-muted mt-2 d-block"><?php echo e($counts['flagged']); ?> flagged items</small>
                    </div>
                </div>
            </div>
                ...
                <div class="card metric-card-advanced">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div class="text-end">
                                <div class="metric-value-large" style="font-size: 2rem;"><?php echo e(number_format($metrics['qa_approval_rate'], 1)); ?>%</div>
                                <div class="metric-label mb-0">QA Approval Rate</div>
                            </div>
                        </div>
                        <div class="metric-progress">
                            <div class="progress-fill" style="width: <?php echo e($metrics['qa_approval_rate']); ?>%; background: var(--grad-info);"></div>
                        </div>
                        <small class="text-muted mt-2 d-block"><?php echo e(number_format($counts['approved'])); ?> approved questions</small>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                <a href="<?php echo e(route('admin.fields.index')); ?>" class="quick-action-card">
                    <div class="action-icon">
                        <i class="fas fa-layer-group"></i>
                    </div>
                    <div class="action-count"><?php echo e($counts['fields']); ?></div>
                    <div class="action-title">Fields</div>
                    <div class="action-description">Subject areas</div>
                </a>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                <a href="<?php echo e(route('admin.tracks.index')); ?>" class="quick-action-card">
                    <div class="action-icon">
                        <i class="fas fa-route"></i>
                    </div>
                    <div class="action-count"><?php echo e($counts['tracks']); ?></div>
                    <div class="action-title">Tracks</div>
                    <div class="action-description">Learning paths</div>
                </a>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                <a href="<?php echo e(route('admin.skills.index')); ?>" class="quick-action-card">
                    <div class="action-icon">
                        <i class="fas fa-brain"></i>
                    </div>
                    <div class="action-count"><?php echo e($counts['skills']); ?></div>
                    <div class="action-title">Skills</div>
                    <div class="action-description">Competencies</div>
                </a>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                <a href="<?php echo e(route('admin.questions.index')); ?>" class="quick-action-card">
                    <div class="action-icon">
                        <i class="fas fa-question-circle"></i>
                    </div>
                    <div class="action-count"><?php echo e(number_format($counts['questions'])); ?></div>
                    <div class="action-title">Questions</div>
                    <div class="action-description">Practice items</div>
                </a>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                <a href="<?php echo e(route('admin.qa.index')); ?>" class="quick-action-card">
                    <div class="action-icon" style="background: var(--grad-warning);">
                        <i class="fas fa-clipboard-check"></i>
                    </div>
                    <div class="action-count"><?php echo e($counts['pending_qa']); ?></div>
                    <div class="action-title">QA Review</div>
                    <div class="action-description">Needs attention</div>
                </a>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                <a href="<?php echo e(route('admin.users.index')); ?>" class="quick-action-card">
                    <div class="action-icon" style="background: var(--grad-success);">
                        <i class="fas fa-users"></i>
                    </div>
                    <div class="action-count"><?php echo e(number_format($counts['total_users'])); ?></div>
                ...
                <div class="insight-panel">
                    <div class="insight-header">
                        ...
                        <div class="insight-content">
                            <h4><?php echo e($insights['top_track']['name']); ?> Track Excelling</h4>
                            <p><?php echo e($insights['top_track']['question_count']); ?> questions with <?php echo e(number_format($insights['top_track']['approval_rate'], 1)); ?>% QA approval rate. This track can serve as a quality benchmark.</p>
                        </div>
                    </div>
                </div>
                <?php endif; ?>

                <?php if($insights['needs_attention']): ?>
                <div class="insight-panel">
                    <div class="insight-header">
                        ...
                        <div class="insight-content">
                            ...
                            <p><?php echo e($counts['pending_qa']); ?> questions pending review. Consider allocating more QA resources to reduce wait times.</p>
                        </div>
                    </div>
                </div>
                <?php endif; ?>

                <?php if($metrics['content_growth_rate'] > 0): ?>
                <div class="insight-panel">
                    <div class="insight-header">
                        ...
                        <div class="insight-content">
                            ...
                            <p><?php echo e($metrics['questions_last_30days']); ?> questions created in the last 30 days, representing <?php echo e(number_format($metrics['content_growth_rate'], 1)); ?>% growth.</p>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="activity-timeline">
                    <?php $__empty_1 = true; $__currentLoopData = $recent_questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="timeline-item">
                        <div class="timeline-dot"></div>
                        <div class="timeline-content">
                            <div class="timeline-title">Question <?php echo e($question['qa_status'] === 'approved' ? 'Approved' : 'Created'); ?></div>
                            <div class="timeline-description"><?php echo e($question['question']); ?></div>
                            <div class="timeline-time">
                                <i class="fas fa-clock me-1"></i><?php echo e($question['updated_at']->diffForHumans()); ?>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="card" style="border-left: 4px solid var(--warning-color);">
                    <div class="card-body">
                        <h4 class="text-warning mb-2"><?php echo e(number_format($counts['unreviewed'])); ?></h4>
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="card" style="border-left: 4px solid var(--success-color);">
                    <div class="card-body">
                        <h4 class="text-success mb-2"><?php echo e(number_format($counts['approved'])); ?></h4>
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="card" style="border-left: 4px solid var(--error-color);">
                    <div class="card-body">
                        <h4 class="text-danger mb-2"><?php echo e(number_format($counts['flagged'])); ?></h4>
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="card" style="border-left: 4px solid var(--info-color);">
                    <div class="card-body">
                        <h4 class="text-info mb-2"><?php echo e(number_format($counts['needs_revision'])); ?></h4>
...
const fieldDistribution = <?php echo json_encode($field_distribution, 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\allgifted\mathapi11v2\resources\views\admin\dashboard\index.blade.php ENDPATH**/ ?>