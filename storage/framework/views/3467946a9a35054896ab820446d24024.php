      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="card">
            ...
            <div class="card-body">
              <?php $__currentLoopData = $site; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php $k=$it['k']; $type=$it['type']; $val = old($k, $get($k)); ?>
              <div class="mb-3">
                <label class="form-label fw-semibold"><?php echo e($it['label']); ?></label>
                <div class="border rounded p-2 d-flex align-items-center inline-edit" data-field="<?php echo e($k); ?>">
                  <span class="flex-grow-1 value-display" data-raw="<?php echo e($val); ?>"><?php echo e($val); ?></span>
                  <?php if($type==='select'): ?>
                  <select class="form-select form-select-sm d-none edit-input">
                    <?php $__currentLoopData = ($it['options'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ov => $ol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($ov); ?>" <?php echo e((string)$val===(string)$ov?'selected':''); ?>><?php echo e($ol); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                  <?php elseif($type==='textarea'): ?>
                  <textarea rows="3" class="form-control d-none edit-input"><?php echo e($val); ?></textarea>
                  <?php else: ?>
                  <input class="form-control form-control-sm d-none edit-input" type="<?php echo e($type); ?>" value="<?php echo e($val); ?>" <?php if(isset($it['min'])): ?> min="<?php echo e($it['min']); ?>" <?php endif; ?> <?php if(isset($it['max'])): ?> max="<?php echo e($it['max']); ?>" <?php endif; ?> />
                  <?php endif; ?>
                ...
                <?php if(!empty($it['desc'] ?? null)): ?>
                <div class="text-muted small mt-1"><?php echo e($it['desc']); ?></div>
                <?php endif; ?>
              </div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="mb-4">
                ...
                ?>
                <?php if($logoPath && file_exists(public_path($logoPath))): ?>
                <div class="border rounded p-2 bg-light">
                  <img id="logoImg" src="<?php echo e($logoUrl); ?>" class="img-fluid d-block mx-auto mb-2" style="max-height:80px" alt="Logo">
              ...
              <div class="mb-4">
                ...
                ?>
                <?php if($faviconPath && file_exists(public_path($faviconPath))): ?>
                <div class="border rounded p-2 bg-light text-center">
                  <img id="faviconImg" src="<?php echo e($faviconUrl); ?>" class="d-block mx-auto mb-2" style="width:32px;height:32px" alt="Favicon">
                  <div class="d-flex gap-2 justify-content-center">
      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="card">
            ...
            <div class="card-body">
              <?php $__currentLoopData = $email; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php
              $k   = $it['k'];
              $type= $it['type'];
              ...
              <div class="mb-3">
                ...
                <div class="border rounded p-2 d-flex align-items-center inline-edit" data-field="<?php echo e($k); ?>">
                  ...
                  <?php else: ?>
                  <input class="form-control form-control-sm d-none edit-input" type="<?php echo e($type); ?>" value="<?php echo e($val); ?>"
                  <?php if(isset($it['min'])): ?> min="<?php echo e($it['min']); ?>" <?php endif; ?>
                  <?php if(isset($it['max'])): ?> max="<?php echo e($it['max']); ?>" <?php endif; ?> />
                  <?php endif; ?>
                  <small class="ms-2 text-success d-none save-indicator"><i class="fas fa-check"></i> Saved</small>
                  <small class="ms-2 text-danger d-none error-indicator"><i class="fas fa-times"></i> Error</small>
                </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="card mb-3">
            ...
            <div class="card-body">
              <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php $k=$it['k']; $type=$it['type']; $val = old($k, $get($k)); ?>
              <div class="mb-3">
                <label class="form-label fw-semibold"><?php echo e($it['label']); ?></label>
                <div class="border rounded p-2 d-flex align-items-center inline-edit" data-field="<?php echo e($k); ?>">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <?php $__currentLoopData = $layout; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php $k=$it['k']; $type=$it['type']; $val = old($k, $get($k)); ?>
              <div class="mb-3">
                <label class="form-label fw-semibold"><?php echo e($it['label']); ?></label>
                <div class="border rounded p-2 d-flex align-items-center inline-edit" data-field="<?php echo e($k); ?>">
        ...
        <div class="col-lg-6">
          <div class="card">
            ...
            <div class="card-body">
              <?php $__currentLoopData = $typography; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php $k=$it['k']; $type=$it['type']; $val = old($k, $get($k)); ?>
              <div class="mb-3">
                <label class="form-label fw-semibold"><?php echo e($it['label']); ?></label>
                <div class="border rounded p-2 d-flex align-items-center inline-edit" data-field="<?php echo e($k); ?>">
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="card mb-3">
            ...
            <div class="card-body">
              <?php $__currentLoopData = $learning; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php $k=$it['k']; $type=$it['type']; $val = old($k, $get($k)); ?>
              <div class="mb-3">
                <label class="form-label fw-semibold"><?php echo e($it['label']); ?></label>
                <div class="border rounded p-2 d-flex align-items-center inline-edit" data-field="<?php echo e($k); ?>">
            ...
            <div class="card-body">
              <div class="mb-3">
                ...
                <div class="form-check form-switch">
                  <input class="form-check-input" type="checkbox" data-field="self_paced" onchange="updateToggle(this)" <?php echo e($get('self_paced') ? 'checked' : ''); ?>>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="mb-3">
            ...
            <div class="form-check form-switch">
              <input class="form-check-input" type="checkbox" data-field="maintenance_mode" onchange="updateToggle(this)" <?php echo e($get('maintenance_mode') ? 'checked' : ''); ?>>
              <span class="text-muted small">Put the site in maintenance mode</span>
            </div>
          </div>

          <?php $k='maintenance_message'; $val = old($k, $get($k)); ?>
          <div class="mb-0">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\allgifted\mathapi11v2\resources\views\admin\settings\general.blade.php ENDPATH**/ ?>