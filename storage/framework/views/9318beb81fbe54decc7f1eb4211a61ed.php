  ...
  <?php $__env->startComponent('admin.components.filters-card', ['items' => []]); ?>
    <div class="col-md-2">
      <select class="form-select" id="fieldFilter">
        ...
        <?php $__currentLoopData = ($filterOptions['fields'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <option value="<?php echo e($f['id'] ?? $f->id); ?>"><?php echo e($f['field'] ?? $f->field); ?></option>
    ...
    <div class="col-md-2">
      <select class="form-select" id="skillFilter">
        ...
        <?php $__currentLoopData = ($filterOptions['skills'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <option value="<?php echo e($s->id); ?>"><?php echo e($s->skill); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </select>
    </div>
    <div class="col-md-2">
      <select class="form-select" id="difficultyFilter">
        ...
        <?php $__currentLoopData = ($filterOptions['difficulties'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <option value="<?php echo e($d['id'] ?? $d->id); ?>"><?php echo e($d['text'] ?? ($d->short_description ?? '')); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </select>
    </div>
    <div class="col-md-2">
      <select class="form-select" id="statusFilter" name="status_id">
        ...
        <?php $__currentLoopData = ($filterOptions['statuses'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <option value="<?php echo e($st['id'] ?? $st->id); ?>"><?php echo e($st['text'] ?? ($st->status ?? '')); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </select>
    </div>
    <div class="col-md-2">
      <select class="form-select" id="qaStatusFilter">
        ...
        <?php $qas = $filterOptions['qa_statuses'] ?? []; ?>
        <?php if(is_array($qas)): ?>
          <?php $__currentLoopData = $qas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(is_string($key)): ?>
              <option value="<?php echo e($key); ?>"><?php echo e($val ?: ucfirst(str_replace('_',' ', $key))); ?></option>
            <?php else: ?>
              <option value="<?php echo e($val); ?>"><?php echo e(ucfirst(str_replace('_',' ', $val))); ?></option>
            <?php endif; ?>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
      </select>
    ...
    <div class="col-md-2">
      <select class="form-select" id="typeFilter">
        ...
        <?php $__currentLoopData = ($filterOptions['types'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <option value="<?php echo e($t['id'] ?? $t->id); ?>"><?php echo e($t['text'] ?? ($t->type ?? '')); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </select>
    </div>
    <div class="col-md-2">
      <select class="form-select" id="sourceFilter">
        ...
        <?php $__currentLoopData = ($filterOptions['sources'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $src): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="table-responsive">
            <table id="question-table" class="table table-hover mb-0">
              ...
              <tbody id="questionsTableBody">
                <?php echo $__env->make('admin.questions.table-body', ['questions' => $questions], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
              </tbody>
            </table>
          </div>
        </div>
        ...
        <div class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <select class="form-select" name="type_id" id="cq-type" required>
              <?php $__currentLoopData = ($filterOptions['types'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $tid = $t['id'] ?? $t->id; $ttext = $t['text'] ?? ($t->type ?? "Type #$tid"); ?>
                <option value="<?php echo e($tid); ?>"><?php echo e($ttext); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
          </div>
          ...
          <div class="col-md-6">
            ...
            <select class="form-select" name="difficulty_id" id="cq-difficulty">
              <option value="">—</option>
              <?php $__currentLoopData = ($filterOptions['difficulties'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $did = $d['id'] ?? $d->id; $dtext = $d['text'] ?? ($d->short_description ?? "Difficulty #$did"); ?>
                <option value="<?php echo e($did); ?>"><?php echo e($dtext); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
          </div>
          ...
          <div class="col-md-6">
            ...
            <select class="form-select" name="status_id" id="cq-status">
              <?php $__currentLoopData = ($filterOptions['statuses'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $sid = $st['id'] ?? $st->id; $slabel = $st['text'] ?? ($st->status ?? "Status #$sid"); ?>
                <option value="<?php echo e($sid); ?>"><?php echo e($slabel); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
          </div>
...
<?php $__env->startPush('scripts'); ?>
  ...
  function loadQuestions(page = 1) {
    ...
    const url = new URL("<?php echo e(route('admin.questions.index')); ?>", window.location.origin);
 ...
 function submitGenerate(e){
  ...
  fetch("<?php echo e(url('/admin/questions/generate')); ?>", {
    method:'POST',
    headers:{
...
function submitCreate(e){
  ...
  fetch("<?php echo e(url('/admin/questions')); ?>", {
    method: 'POST',
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\allgifted\mathapi11v2\resources\views\admin\questions\index.blade.php ENDPATH**/ ?>