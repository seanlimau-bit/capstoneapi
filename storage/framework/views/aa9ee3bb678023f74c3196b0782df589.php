    ...
    <div class="auth-container">
        <div class="card auth-card">
            <div class="auth-header">
                ...
                <p class="auth-subtitle"><?php echo $__env->yieldContent('subtitle', 'Admin Portal'); ?></p>
            </div>
            ...
            <div class="auth-footer">
                <small>&copy; <?php echo e(date('Y')); ?> All Gifted Math. All rights reserved.</small>
            </div>
        </div>
    </div>
...
</html><?php /**PATH C:\allgifted\mathapi11v2\resources\views\admin\qa\auth.blade.php ENDPATH**/ ?>