    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="border rounded p-3 mb-3 bg-light">
          ...
          <div class="small">
            <div><strong>Skill:</strong> <?php echo e($skill->skill ?? ''); ?></div>
            <?php if(!empty($skill?->description)): ?>
              <div class="text-muted text-truncate"><strong>Description:</strong> <?php echo e($skill->description); ?></div>
            <?php endif; ?>
          </div>
        </div>
        ...
        <div class="row g-3 mb-3" id="<?php echo e($modalId); ?>_picker">
        ...
        <form id="<?php echo e($modalId); ?>_form_skills" class="d-none">
          <input type="hidden" name="skill_id" value="<?php echo e($skillId); ?>">
          <div class="row">
          ...
          <div class="form-check form-switch mb-2">
            <input class="form-check-input" type="checkbox" id="<?php echo e($modalId); ?>_explain_sk" name="include_explanations" checked>
            <label class="form-check-label" for="<?php echo e($modalId); ?>_explain_sk">Include explanations</label>
          </div>
        ...
        <form id="<?php echo e($modalId); ?>_form_questions" class="d-none">
          <input type="hidden" name="skill_id" value="<?php echo e($skillId); ?>">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="question_id" id="<?php echo e($modalId); ?>_questionId" placeholder="Question ID">
          </div>
          ...
          <div class="form-check form-switch mb-2">
            <input class="form-check-input" type="checkbox" id="<?php echo e($modalId); ?>_explain_q" name="include_explanations" checked>
            <label class="form-check-label" for="<?php echo e($modalId); ?>_explain_q">Include explanations</label>
          </div>
        ...
        <div id="<?php echo e($modalId); ?>_progress" class="d-none">
          <div class="d-flex align-items-center mb-2">
            ...
            <div class="flex-grow-1">
              <div class="d-flex justify-content-between mb-1">
                ...
                <span id="<?php echo e($modalId); ?>_pct">0%</span>
              </div>
              <div class="progress">
                <div class="progress-bar" id="<?php echo e($modalId); ?>_bar" style="width:0%"></div>
              </div>
            </div>
          </div>
          <div class="small text-muted" id="<?php echo e($modalId); ?>_msgs"><div>Starting…</div></div>
        </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="<?php echo e($modalId); ?>_submit" disabled>
...
<script>
(function() {
  const modalId = <?php echo json_encode($modalId, 15, 512) ?>;
  const actionUrl = <?php echo json_encode($actionUrl, 15, 512) ?>;
  ...
  submitBtn?.addEventListener('click', async () => {
    ...
    if (method === 'skills') {
      ...
      if (!fd.get('skill_id')) fd.set('skill_id', '<?php echo e($skillId); ?>');
    } else {
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\allgifted\mathapi11v2\resources\views\admin\components\question-generation-modal.blade.php ENDPATH**/ ?>